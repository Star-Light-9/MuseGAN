...
- ##Shared Temporal Generator:
  Takes two noise vectors and upscales them, this is the temporal context of music - to be given to Private Temporal Generator.
- ##Private Temporal Generator:
  Takes combined vector containing two outputs from bar generator as well as other two directly passed to it and gives the content for one track.
- ##Bar Generator:
  Takes the 5 bars generated from the Private Temporal Generator and combines them to form a pianoroll.
